...
namespace jetnetSampleClient
{
  ...
  class JetnetDataServiceConnection
  {
    ...
    public IEnumerable<dynamic> getAircraftList(string airframetype = null, string maketype = null, string sernbr = null, string regnbr = null, string modelid = null,
                                                ...
                                                string yearmfr = null, string yeardlv = null, string aircraftchanges = null)
    {
      dynamic results = RequestInformation("GET", "getAircraftList", "airframetype=" + airframetype + "&maketype=" + maketype + "&sernbr=" + sernbr + "&regnbr=" + regnbr + "&modelid=" + modelid + "&make=" + make +
                                                                     ...
                                                                     "&actiondate=" + actiondate + "&companyid=" + companyid + "&contactid=" + contactid + "&yearmfr=" + yearmfr + "&yeardlv=" + yeardlv + "&aircraftchanges=" + aircraftchanges, securityToken).Result;
    ...
    {
      dynamic results = RequestInformation("GET", "getAircraftEventList", "aircraftid=" + aircraftid + "&modelid=" + modelid + "&make=" + make + "&eventcategory=" + category + "&eventtype=" + evtype + "&startdate=" + startdate + "&enddate=" + enddate, securityToken).Result;
    ...
    public IEnumerable<dynamic> getAircraftHistoryList(string aircraftid = null, string airframetype = null, string maketype = null, string modelid = null, string make = null,
                                                       string companyid = null, string allrelationships = null, string transtype = null, string startdate = null, string enddate = null)
    {
      dynamic results = RequestInformation("GET", "getAircraftHistoryList", "aircraftid=" + aircraftid + "&airframetype=" + airframetype + "&maketype=" + maketype + "&modelid=" + modelid + "&make=" + make +
                                                                            "&companyid=" + companyid + "&allrelationships=" + allrelationships + "&transtype=" + transtype + "&startdate=" + startdate + "&enddate=" + enddate, securityToken).Result;
    ...
    public IEnumerable<dynamic> getCompanyList(string acid = null, string name = null, string country = null, string city = null,
                                               ...
                                               string relationship = null, string isoperator = null, string actiondate = null, string companychanges = null, string website = null)
    {
    ...
    public IEnumerable<dynamic> getContactList(string acid = null, string compid = null, string companyname = null, string firstname = null, string lastname = null,
                                        string title = null, string email = null, string actiondate = null, string phonenumber = null, string contactchanges = null)
    {
      dynamic results = RequestInformation("GET", "getContactList", "aircraftid=" + acid + "&companyid=" + compid + "&companyname=" + companyname + "&firstname=" + firstname + "&lastname=" + lastname + "&title=" + title + "&email=" + email + "&actiondate=" + actiondate + "&phonenumber=" + phonenumber + "&contactchanges=" + contactchanges, securityToken).Result;
